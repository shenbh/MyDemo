...
public class PopUpwindowLayout extends LinearLayout {
	 ...
	 * @param context
	 * @param orderedDishes  */
	public void initViews(Context context, List<Map<String, Object>> orderedDishes) {
		initViews(context, orderedDishes,true);
	}
	 ...
	 *            是否带右侧向下箭�?
	 * */
	public void initViews(Context context, List<Map<String, Object>> orderedDishes, boolean hasDraw) {
		this.mContext = context;
		setLayoutContent(mContext, hasDraw);
	}
	 ...
	 * @param hasDraw
	 */
	private void setLayoutContent(Context context, boolean hasDraw) {

		if(null == mainLayout){
			mainLayout = context.findViewById(R.id.popupwindow_main);
		}

		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		inflater.inflate(R.layout.ordercart_popupwindow, mainLayout,true);
